...
# OSM Foreign Data Wrapper
ENV OSM_FWD_DEPS="libjson-c-dev libjson-c3 libprotobuf-c-dev protobuf-c-compiler libprotobuf-c1 zlib1g-dev zlib1g"

RUN apt-get install $OSM_FWD_DEPS -y --no-install-recommends
